...
import { useCreateProductMutation, useGetAllProductCategoriesQuery } from "../../../redux/services/product"
...
const NewProduct: NextPage = () => {
  ...
  const { register, handleSubmit: onSubmit, formState: { errors } } = useForm<ProductDetailFormData>()
